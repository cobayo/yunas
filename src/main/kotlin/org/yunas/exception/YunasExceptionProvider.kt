...
class YunasExceptionProvider {
    ...
    fun failToGetApplicationProperties(cause: Throwable?): YunasException {
        return YunasException("FAIL_TO_GET_APPLICATION_PROPERTIES", "YunasApp can not get org.yunas.configuration", cause)
    }

    fun failToGetApplicationProperties(): YunasException {
        return YunasException("FAIL_TO_GET_APPLICATION_PROPERTIES", "YunasApp can not get org.yunas.configuration")
    }
