...
import org.yunas.filter.StaticFilter
import org.yunas.handler.AppServlet
import org.yunas.handler.AppServletHandler
import org.yunas.handler.BaseErrorHandler
import java.io.File
import java.net.URI
import java.util.*
    ...
    private val resourceBase: String
        get() {
            ...
            if (entry != null) {
                ...
                val path = "/org/yunas/server".replace("/",File.separator)
